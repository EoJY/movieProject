...
public class SeatType extends Seat{
		...
		void book(String[][] s,String[][] a,String[][] b){ //좌석을 예약을 할 때 사용하는 메소드
			...
			System.out.println("S좌석은 1~10 까지");
			System.out.println("A좌석은 1~15 까지");
			System.out.println("B좌석은 1~15 까지");
		...
		void cancel(String[][] s, String[][] a, String[][] b){ //취소를 할 때 사용하는 메소드
			System.out.println("취소하실 좌석을 번호로 입력하세요");
			System.out.println("입력하신 좌석이 없으실 경우 4번을 입력하세요");
			System.out.print("좌석구분 S(1), A(2), B(3)>>");
			Scanner input = new Scanner(System.in);
...
//			}
			...
			System.out.println("취소하실 이름을 입력하세요");
